...
CC_SCOPE_RULES=(
  ...
  "src/index.js|api|refactor|重整服務路由與靜態資產流程"
  "src/utils.js|api|fix|改善共用介面工具"
  "src/*|api|fix|改善後端行為"
  ...
  "web/*|web|feat|更新網站靜態資源"
  "deploy.sh|deploy|chore|改善部署流程"
  "deploy.ps1|deploy|chore|改善指令稿部署流程"
  "conventional_commit_rules.sh|tooling|chore|調整提交訊息規則"
  "tool/*|tooling|chore|改善開發工具"
  "wrangler.jsonc|deploy|chore|調整部署平台設定"
  ...
  "package.json|tooling|chore|更新工具設定"
  "package-lock.json|tooling|chore|更新工具鎖定依賴"
  "pubspec.lock|app|chore|更新前端鎖定依賴"
  "*|app|chore|更新專案檔案"
)
